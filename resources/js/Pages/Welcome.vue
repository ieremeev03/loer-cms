    ...
    >
        <div v-if="canLogin" class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
            ...
            <template v-else>
                ...
                <Link
                    href="/p/sit-et"
                    class="ml-2 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"
                    >Page</Link
                >
                    ...
                    >
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                111Laravel has wonderful documentation covering every aspect of the framework. Whether you
