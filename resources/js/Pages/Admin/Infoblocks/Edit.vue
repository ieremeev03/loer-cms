                        ...
                        <template v-for="(item, index_i) in form.items"  :key="index_i">
                            <div class="p-4 bg-gray-50 rounded-lg" :id="'item_'+index_i">
                                ...
                                <div class="flex flex-row items-center justify-end gap-2">
                                    ...
                                    <span class="cursor-pointer p-2 bg-indigo-500 rounded-lg text-xs text-white" @click="moveUp(index_i)">
                                    ...
                                    <span class="cursor-pointer p-2 bg-indigo-500 rounded-lg text-xs text-white" @click="moveDown(index_i)">
