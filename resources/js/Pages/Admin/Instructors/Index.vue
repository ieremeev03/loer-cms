<template>
    <AdminLayout>
        <Head title = "Административная панель Инструкторы"></Head>

        <section >
            <div class="p-4 mt-6 space-y-6 ">
                <div class="flex items-center justify-between flex-wrap">
                    <h1 class="text-lg font-medium text-black-50">Инструкторы</h1>
                    <div class="flex flex-row gap-6">
                        <a :href="route('instructor.price')" class="bg-gray-700 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Цены
                        </a>

                        <a :href="route('instructor.table')" class="bg-gray-700 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Расписание
                        </a>

                        <a :href="route('instructor.edit')" class="bg-gray-700 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Создать инструктора
                        </a>
                    </div>
                ...
                <div class="relative overflow-x-auto rounded">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3">Дисциплина</th>
                            <th>Действия</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr v-for="instructor in instructors" class="bg-white border-b dark:bg-white dark:border-gray-700">
                            <td scope="row" class="w-3 px-6 py-4 font-medium whitespace-nowrap ">
                                {{instructor.id}}
                            </td>
                            <td scope="row" class="px-6 py-4 font-medium whitespace-nowrap w-full">
                                <a :href="route('instructor.edit', instructor.id)" class="hover:text-blue-500">{{ instructor.name }}</a>
                            </td>
                            ...
                            <td class="flex items-center px-6 py-4 space-x-3">
                                <a :href="route('instructor.edit', instructor.id)" class="font-medium text-blue-600  hover:underline">
                                ...
                                <!--                                    <a href="#" @click="" class="font-medium text-blue-600  hover:underline">
                                                                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="#" @click="" class="font-medium text-red-600 dark:text-red-500 hover:underline">
                                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
