            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white shadow-xl sm:rounded-lg p-5">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" v-model="instructor.name" class="w-full" required>
                    </div>
                    <div class="mb-2">
                    ...
                    <button @click="save"
                        class="mb-5 mr-3 rounded bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
                    >Сохранить</button>

                    <div v-if="instructor.id">
                        <VueDatePicker
                            format="dd/MM/yyyy"
                            v-model="date"
                    ...
                    <div v-if="instructor.times" class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                    ...
                    <div v-if="instructor.times" class="mt-2">
                        <button @click="save"
                            class="btn btn-blue"
                        >Сохранить</button>
